...
sample applications is available in the [optix-dev repository]
(https://github.com/NVIDIA/optix-dev). The optix-dev repository can be used
instead of the complete SDK for CI/CD workflows, automated installations, and
container-based development environments.

Visit the [OptiX home page]
(https://developer.nvidia.com/rtx/ray-tracing/optix) for an in-depth
